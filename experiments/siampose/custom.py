...
class Refine(nn.Module):
    def __init__(self):
        ...
        self.v0 = nn.Sequential(nn.Conv2d(64, 64, 3, padding=1), nn.ReLU(),
        ...
        self.h0 = nn.Sequential(nn.Conv2d(16, 16, 3, padding=1), nn.ReLU(),
                           nn.Conv2d(16, 32, 3, padding=1), nn.ReLU())

        self.deconv = nn.ConvTranspose2d(256, 32, 15, 15)

        self.post0 = nn.Conv2d(32, 16, 3, padding=1)
        self.post1 = nn.Conv2d(16, 16, 3, padding=1)
        self.post2 = nn.Conv2d(32, 18, 3, padding=1)
